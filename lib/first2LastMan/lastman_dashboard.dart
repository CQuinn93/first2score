...
import '../Login/login_screen.dart'; // Import the LoginScreen for logout

class LastManDashboardScreen extends StatefulWidget {
  const LastManDashboardScreen({super.key});

  @override
  LastManDashboardScreenState createState() => LastManDashboardScreenState();
}

class LastManDashboardScreenState extends State<LastManDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Image.asset(
          'lib/assets/F2LM_logo.png', // Updated logo
          height: 40,
        ),
        centerTitle: true,
        actions: [
      ...
      body: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _menuButton("My Competitions", 0),
                _menuButton("Open Competitions", 1),
                _menuButton("Join / Create", 2),
              ],
            ),
          ),
          ...
          Expanded(
            child: IndexedStack(
              ...
              children: [
                 // Tab 1: Create/Join Competitions
                ...
                const CreateJoinView(), // Tab 3: Open Competitions
              ],
            ),
          ),
